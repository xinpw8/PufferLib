...
staged=$run/RekUiBridgeAgent-any-ai-transport-20260917.dll
relay=$run/RekUiPipeClient-any-ai-20260917.exe
backup=$run/RekUiBridgeAgent-pre-any-ai-transport-20260917.dll
evidence=/home/spark-advantage/rek-training/policy-quality-20260916-r1/any-ai-transport-deployment
mkdir "$evidence"

...
function validateWorkerReady(ready, sha, featureMaskSha = null) {
...
async function run(configPath) {
  ...
  try {
    ...
    validateWorkerReady(ready, config.checkpoint_sha256, config.feature_mask_sha256);
...
module.exports={privateArena,botIdentity,validateBotIdentity,trialExitCode,canExitLostPrivateSession,canReadyPrivateAiSession,ensurePrivateArena,betweenPrivateRounds,canRequestPrivateRound,validateWorkerReady,validateWorkerAction,guardedCallback,sendAndWait,childEndpoint,LiveActionPacer,provenG1T800Pairing,rejectUnsupportedActivePairing};

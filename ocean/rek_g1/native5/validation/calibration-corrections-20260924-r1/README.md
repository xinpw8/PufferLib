...
A fourth continuation removes only that unconditional kick-fall prior from the combined correction (`REK_FAST_KICK_FALL_P=0`). It completed 16,777,216 transitions with zero failure bits at 890,800 full-process SPS. This is an ablation of an unmeasured penalty, not evidence that the kick has zero fall risk. Its frozen live cohort failed the same prospective 18/20 target at the third nonwin: 2 wins and 3 losses, 55:50 points, with scores 7:9, 12:7, 8:14, 21:11 and 7:9. Six additional incomplete attempts are retained separately. Evaluation ended at 05:02:59 UTC on September 24. This candidate is rejected despite its positive aggregate point margin.

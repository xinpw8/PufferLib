...
function captureArgs(video,seconds=140) {
  ...
  return ['-hide_banner','-loglevel','warning','-f','x11grab','-draw_mouse','0',
    '-show_region','0','-follow_mouse','0','-framerate','20','-video_size','1920x1080',

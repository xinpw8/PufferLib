...
| Short-horizon `gamma=0.995` with frameskip 1 | Production uses frameskip 4 and gamma `0.999`; trainer gamma is injected into the environment. | Frameskip and gamma-coupling tests. | Hyperparameter quality pending. |

...
base_compile_args = ['-DNPY_NO_DEPRECATED_API=NPY_1_7_API_VERSION', '-DPLATFORM_DESKTOP', '-O2', '-Wno-alloc-size-larger-than', '-fwrapv']
base_link_args = ['-Bsymbolic-functions', '-O2', '-fwrapv']

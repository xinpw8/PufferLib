...
class RedGymEnvV3(Env):
    ...
    def __init__(
        ...
        self.s_path = '/bet_adsorption_xinpw8/PufferLib/pokegym/pokegym/save_state_dir/has_pokedex_nballs_noanim.state' #config['session_path']
        ...
        self.s_path = '/bet_adsorption_xinpw8/PufferLib/pokegym/pokegym/save_state_dir/'
        Path(self.s_path).mkdir(parents=True, exist_ok=True) # self.s_path.mkdir(parents=True, exist_ok=True)
    ...
    def reset(self, seed=None, options=None):
        ...
        if self.current_level == 0:
            ...
            state_to_init = '/bet_adsorption_xinpw8/PufferLib/pokegym/pokegym/save_state_dir/has_pokedex_nballs_noanim.state'

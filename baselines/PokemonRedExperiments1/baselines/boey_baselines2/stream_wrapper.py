...
class StreamWrapper(gym.Wrapper):
    ...
    def render(self, *args, **kwargs):
        # Optionally handle reduce_res here if needed
        # For now, let's simply ignore it and remove it before calling super().render
        kwargs.pop('reduce_res', None)  # Remove reduce_res if present, no error if absent

'''A custom collector environment. Use this as a template for your own envs.'''

import gymnasium
import numpy as np

import pufferlib
from pufferlib.ocean.sample_gym_env import binding

class SampleGymEnv(pufferlib.PufferEnv):
...
if __name__ == '__main__':
    ...
    print('SampleGymEnv SPS:', int(steps / (time.time() - start)))
    env.close()
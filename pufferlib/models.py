...
#         logits, values = self.policy.decode_actions(next_h)
...
#     """
#     Policy factory that returns the Default policy for environments.
#     Chess environments should use their specific policy from ocean.torch.
#     """

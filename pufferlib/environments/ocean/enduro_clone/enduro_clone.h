...
void allocate_enduro_clone(Enduro* env, int width, int height, int hud_height, int car_width, int car_height,
              int max_enemies, int crash_noop_duration, int day_length, int initial_cars_to_pass,
              float min_speed, float max_speed) {         
...
void free_allocated_enduro_clone(Enduro* env) {
